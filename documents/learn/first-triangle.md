...
<h2 id="1-before-you-begin">1. <resource key="tutorial.requirements.title"></resource>
</h2>
<p>
...
<h2 id="2-create-a-console-project">2. <resource key="tutorial.project.title"></resource>
</h2>
<p>
    <resource key="tutorial.project.description"><slot name="firstTriangle"><code>FirstTriangle</code></slot>
    </resource>
</p>
<p>
...
<ul>
    <li><code>Silk.NET.Windowing</code>
    </li>
    <li><code>Zenith.NET</code>
    </li>
    <li><code>Zenith.NET.Compiler</code>
    </li>
    <li><code>Zenith.NET.DirectX12</code>
    </li>
    <li><code>Zenith.NET.Metal</code>
    </li>
    <li><code>Zenith.NET.Vulkan</code>
    </li>
</ul>
<p>
    <resource key="tutorial.project.guidance"><slot name="zenithNET"><code>Zenith.NET</code></slot>
...
<h2 id="3-open-a-window">3. <resource key="tutorial.window.title"></resource>
</h2>
<p>
...
<p>
    <resource key="tutorial.window.details"><slot name="programCs"><code>Program.cs</code></slot>
...
<p>
    <resource key="tutorial.window.guidance"><slot name="graphicsAPINone"><code>GraphicsAPI.None</code></slot>
        <slot name="initialize"><code>Initialize()</code></slot><slot name="center"><code>Center()</code></slot>
        <slot name="run"><code>Run()</code></slot><slot name="dispose"><code>Dispose()</code></slot>
    </resource>
</p>
<p>
...
<h2 id="4-connect-the-gpu-to-the-window">4. <resource key="tutorial.presentation.title"></resource>
</h2>
...
<p>
    <resource key="tutorial.context.imports"><slot name="programCs"><code>Program.cs</code></slot>
    </resource>
</p>
...
<p>
    <resource key="tutorial.swapChain.context"><slot name="windowDispose"><code>window.Dispose();</code></slot>
...
<h2 id="5-display-a-background-color">5. <resource key="tutorial.frame.title"></resource>
</h2>
<p>
    <resource key="tutorial.frame.description"></resource>
</p>
<p>
    <resource key="tutorial.frame.details"><slot name="value"><code>_</code></slot>
...
<p>
    <resource key="tutorial.frame.commands.details"><slot name="null"><code>null</code></slot>
    </resource>
</p>
<p>
...
<p>
    <resource key="tutorial.resize.description"><slot name="framebufferResize"><code>FramebufferResize</code></slot>
        <slot name="windowRun"><code>window.Run();</code></slot>
    </resource>
</p>
...
<h2 id="6-give-the-gpu-three-vertices">6. <resource key="tutorial.geometry.title"></resource>
</h2>
<p>
...
<p>
    <resource key="tutorial.geometry.format.imports"><slot name="programCs"><code>Program.cs</code></slot>
    </resource>
</p>
...
<p>
    <resource key="tutorial.geometry.format.details"><slot name="file"><code>file</code></slot>
        <slot name="programCs"><code>Program.cs</code></slot>
        <slot name="layoutKindSequential"><code>LayoutKind.Sequential</code></slot>
        <slot name="position"><code>Position</code></slot><slot name="color"><code>Color</code></slot>
    </resource>
</p>
...
<p>
    <resource key="tutorial.geometry.data.details"><slot name="vertex"><code>Vertex</code></slot>
        <slot name="new"><code>new</code></slot><slot name="vector3"><code>Vector3</code></slot>
        <slot name="vector4"><code>Vector4</code></slot><slot name="w"><code>w = 1</code></slot>
    </resource>
</p>
<p>
...
<p>
    <resource key="tutorial.geometry.upload.imports"><slot name="programCs"><code>Program.cs</code></slot>
...
<p>
    <resource key="tutorial.geometry.upload.context"><slot name="fixed"><code>fixed</code></slot>
        <slot name="upload"><a class="xref" href="xref:Zenith.NET.Buffer.Upload(System.UInt32,Zenith.NET.BufferData)"><code>Upload</code></a></slot>
    </resource>
</p>
<p>
...
<h2 id="7-write-the-two-shader-stages">7. <resource key="tutorial.shaders.title"></resource>
</h2>
<p>
    <resource key="tutorial.shaders.description"></resource>
</p>
<p>
    <resource key="tutorial.shaders.details"><slot name="triangleSlang"><code>Triangle.slang</code></slot>
    </resource>
</p>
...
<p>
    <resource key="tutorial.shaders.guidance"><slot name="vSInput"><code>VSInput</code></slot>
        <slot name="pOSITION0"><code>POSITION0</code></slot><slot name="cOLOR0"><code>COLOR0</code></slot>
    </resource>
</p>
<p>
    <resource key="tutorial.shaders.context"><slot name="fSInput"><code>FSInput</code></slot>
        <slot name="sVPOSITION"><code>SV_POSITION</code></slot><slot name="cOLOR0"><code>COLOR0</code></slot>
    </resource>
</p>
...
<p>
    <resource key="tutorial.shaders.vertex.description"><slot name="triangleSlang"><code>Triangle.slang</code></slot>
    </resource>
</p>
...
<p>
    <resource key="tutorial.shaders.vertex.details"><slot name="w"><code>w = 1</code></slot>
    </resource>
</p>
...
<p>
    <resource key="tutorial.shaders.fragment.details"><slot name="fSMain"><code>FSMain</code></slot>
...
<p>
    <resource key="tutorial.shaders.compilation.details"><slot name="programCs"><code>Program.cs</code></slot>
    </resource>
</p>
...
<p>
    <resource key="tutorial.shaders.compilation.guidance">
        ...
        <slot name="vSMain"><code>VSMain</code></slot><slot name="fSMain"><code>FSMain</code></slot>
    </resource>
</p>
<p>
...
<h2 id="8-describe-the-vertex-input-layout">8. <resource key="tutorial.input.title"></resource>
</h2>
<p>
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td><code>POSITION0</code>
            </td>
        </tr>
        <tr>
            <td><code>Vertex.Color</code>
            </td>
            <td>12</td>
            <td>
...
<h2 id="9-connect-the-shaders-and-vertex-layout">9. <resource key="tutorial.pipeline.title"></resource>
</h2>
<p>
...
<h2 id="10-draw-the-triangle-inside-the-pass">10. <resource key="tutorial.draw.title"></resource>
</h2>
<p>
    <resource key="tutorial.draw.description"><slot name="windowRender"><code>window.Render</code></slot>
...
<h2 id="11-run-resize-and-close">11. <resource key="tutorial.execution.title"></resource>
</h2>
<p>
    <resource key="tutorial.execution.description"><slot name="firstTriangle"><code>FirstTriangle</code></slot>
    </resource>
</p>
...
<p>
    <resource key="tutorial.lifecycle.details"><slot name="run"><code>Run</code></slot>
        <slot name="windowRun"><code>window.Run();</code></slot>
    </resource>
</p>
