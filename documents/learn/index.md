...
<div class="learn-hub">
  ...
  <div class="concept-list">
    <a href="concepts/execution-model.md"><i class="bi bi-diagram-3" aria-hidden="true"></i><span><strong>Execution Model</strong><small>Contexts, queues, commands, and ownership.</small></span></a>
    <a href="concepts/resource-management.md"><i class="bi bi-layers" aria-hidden="true"></i><span><strong>Resource Management</strong><small>Memory, resource usages, heaps, and views.</small></span></a>
    <a href="concepts/shader-data-and-binding.md"><i class="bi bi-braces" aria-hidden="true"></i><span><strong>Shader Data and Binding</strong><small>Connect C# data and resources to Slang shaders.</small></span></a>
    <a href="concepts/synchronization.md"><i class="bi bi-arrow-left-right" aria-hidden="true"></i><span><strong>Synchronization</strong><small>Order GPU work and make dependencies explicit.</small></span></a>
    <a href="concepts/platform-integration.md"><i class="bi bi-window" aria-hidden="true"></i><span><strong>Platform Integration</strong><small>Windows, presentation, and UI integration.</small></span></a>
  </div>
</div>
