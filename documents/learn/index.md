    ...
    <div class="learning-entries">
        <a class="learning-entry triangle-entry illustrated-link" href="~/learn/first-triangle.md">
            <svg aria-hidden="true" class="triangle-diagram card-art" viewBox="0 0 180 180">
                ...
                <path class="art-face" d="M90 27 157 145H23Z"></path>
                <path class="art-wire" d="M90 27 157 145H23Z"></path>
                ...
                <circle class="art-node" cx="90" cy="27" r="3.5"></circle>
        ...
        <a class="learning-entry samples-entry illustrated-link" href="~/learn/samples.md">
            <svg aria-hidden="true" class="triangle-diagram card-art" viewBox="0 0 180 180">
                <g class="art-wire">
                    <rect height="50" rx="3" width="58" x="23" y="31"></rect>
                    <rect height="50" rx="3" width="58" x="99" y="31"></rect>
                    <rect height="50" rx="3" width="58" x="23" y="99"></rect>
                    <rect height="50" rx="3" width="58" x="99" y="99"></rect>
                </g>
                ...
                <rect class="art-flow" height="50" pathLength="100" rx="3" width="58" x="23" y="31"></rect>
                <rect class="art-flow" height="50" pathLength="100" rx="3" style="--art-delay: 140ms" width="58" x="99" y="31"></rect>
