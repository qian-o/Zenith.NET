...
<table>
    ...
    <tbody>
        <tr>
            <td>
                <a class="xref" href="xref:Zenith.NET.GraphicsContext.GraphicsQueue"><code>GraphicsQueue</code>
                </a>
            </td>
            <td>
        ...
        <tr>
            <td>
                <a class="xref" href="xref:Zenith.NET.GraphicsContext.ComputeQueue"><code>ComputeQueue</code>
                </a>
            </td>
            <td>
        ...
        <tr>
            <td>
                <a class="xref" href="xref:Zenith.NET.GraphicsContext.TransferQueue"><code>TransferQueue</code>
                </a>
            </td>
            <td>
...
<p>
    <resource key="concepts.execution.recording.details"><slot name="commandBuffer"><code>commandBuffer</code></slot>
    </resource>
</p>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td>
                <a class="xref" href="xref:Zenith.NET.SwapChain.Drawable"><code>SwapChain.Drawable</code>
                </a>
            </td>
            <td>
