...
| graphics API     | API graphique ; DirectX 12, Metal ou Vulkan                                                                                     |
| API implementation | implémentation de l’API graphique ; pour les différences techniques entre implémentations                                      |
| pipeline         | pipeline                                                                                                                       |
