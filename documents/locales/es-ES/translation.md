...
| graphics API     | API gráfica; DirectX 12, Metal o Vulkan                                                                                 |
| API implementation | implementación de la API gráfica; para diferencias técnicas entre implementaciones                                   |
