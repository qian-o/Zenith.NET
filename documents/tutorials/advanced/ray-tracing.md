...
internal unsafe class RayTracingRenderer : IRenderer
{
    ...
    public RayTracingRenderer()
    {
        ...
        Sphere[] sphereData =
        [
            new() { CenterAndRadius = new(-1.5f, 1.0f, 0.0f, 1.0f), ColorAndPadding = new(0.8f, 0.2f, 0.2f, 0.0f) },
            new() { CenterAndRadius = new( 1.5f, 1.0f, 0.0f, 1.0f), ColorAndPadding = new(0.2f, 0.4f, 0.8f, 0.0f) }
        ];
