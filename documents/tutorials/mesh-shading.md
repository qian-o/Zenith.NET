...
Render 1,000 instances of one sphere mesh with task-shader frustum culling and mesh-shader geometry output. The CPU uploads the source mesh; the GPU selects visible instances and emits their vertices and triangles. Start from [Project Setup](project-setup.md), then choose **Mesh Shading** from the tutorial selector.
